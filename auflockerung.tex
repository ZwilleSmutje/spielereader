...
Have you ever seen, a Penguin comes to tea. \\
...
Dann macht die Tutorin die nächste Aktionen vor während sie den rechten Arm wie einen Pinguinflügel an die Seite schlägt.
Am Ende wird dann Erst eins, dann nach jedem Durchgang eins mehr, während die anderen Bewegungen beibehalten werden:
\begin{description}
  \item[Right wing:] die rechte Hand (im Takt) auf den rechten Oberschenkel schlagen
  \item[Left wing:] auch die linke Hand auf den linke Oberschenkel schlagen
  ...
  \item[Now your butt:] Alle wackeln mit dem Popo
  \item[Now the head:] Headbanging 
  \item[Now your tongue:] ab hier kann niemand mehr singen
\end{description}

Das Spiel ist zu Ende, wenn niemand mehr kann oder alle durcheinander purzeln und vor Lachen sich nicht einkriegen.
Falls es mehr Zeit gibt und die Stimmung zum singen da ist kann man hiermit erweitern:
...
\paragraph{Persönliche Erfahrung:} Auf jedem meiner Seminare bisher mindestens einmal gemacht. Kommt immer gut an, ist super schnell und macht lustig. Bester WUP. (Anmerkung von Hackybaby)
